...
dojo.widget.defineWidget(
	...
	dojo.widget.DropdownContainer,
	{
		...
		*/
		...
		displayFormat: "yyyy-MM-dd",  // default set to yyyy-MM-dd by cindy Li on Jan 4, 2007
		...
		onInputChange: function(){
			// added by cindy Li on Jan 4, 2007
			// if input text is yyyymmdd, re-format it to yyyy-mm-dd
			var v = this.inputNode.value;

      if (v.length == 8) {
        this.inputNode.value = v.substr(0,4) + "-" + v.substr(4,2) + "-" + v.substr(6) ;
      }
			// end added by cindy Li on Jan 4, 2007
